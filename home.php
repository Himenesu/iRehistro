                    ...
                    <div class="wrapper">
                        ...
                        <div class="form">
                           <div class="inputfield">
                              ...
                              <input type="text" name="firstname" class="input" placeholder="Iyong unang pangalan" minlength="5" required>
                           </div> 
                           <div class="inputfield">
                            ...
                            <div class="inputfield">
                              ...
                              <input type="text" name="lastname" class="input" placeholder="Iyong apelyido" minlength="5" required>
                           </div>  
                           <div class="inputfield">
                            ...
                            <div class="inputfield">
                              ...
                              <input type="text" name="birthplace" placeholder="Lugar kung saan ka ipinanganak" class="input" required>
                            </div>  
                            <div class="inputfield">
                              <label>Gender:</label>
                          ...
                          <div class="inputfield">
                              ...
                              <input type="number" name="contact" placeholder="ilagay ang iyong telepono" class="input" required>
                           </div> 
                          <div class="inputfield">
                              <label>Postal Code:</label>
                              <input type="number" name="postal" class="input" placeholder="Postal code ng iyong lugar" required>
                           </div> 
                        </div>
                    </div>
